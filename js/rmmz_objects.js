...
Game_Map.prototype.isHomeMap = function() {
    return Config.homeMapIds.includes(this._mapId);
}

Game_Map.prototype.isWorldMap = function() {
    return Config.worldMapIds.includes(this._mapId);
}

Game_Map.prototype.isBattleMap = function() {
    return Config.battleMapIds.includes(this._mapId);
}
...
Game_Player.prototype.triggerTouchAction = function() {
    if ($gameTemp.isDestinationValid() && !SceneManager._scene.isStartBattle()) {
