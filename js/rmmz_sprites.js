...
Sprite_AnimationMV.prototype.onEnd = function() {
  ...
  // REMARK
  if (this.tag === "touchScreenAnimation"){
    for (const sprite of this._cellSprites) {
      sprite.visible = false;
    }
  }
};
...
// 创建虚拟摇杆
Spriteset_Map.prototype.creatVirtualGamePad = function() {
  this._virtualGamePadSprite = new Sprite_VirtualGamePad();
  this._virtualGamePadSprite.z = 10;
  this._tilemap.addChild(this._virtualGamePadSprite);
}
...
Spriteset_Map.prototype.createTouchEffect = function() {
  this._touchEffectSprite = new SpriteBlankTargetAnimation(Config.touchAnimationId);
  this._touchEffectSprite.z = 9;
  this._tilemap.addChild(this._touchEffectSprite);
}
