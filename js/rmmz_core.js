...
Graphics.resize = function(width, height) {
    ...
    const _height = Config.height;

    this._width = _width;
    this._height = _height;

    this.boxWidth = _width;
    this.boxHeight = _height;

    this._app.renderer.resize(_width, _height);
...
Bitmap.prototype._onLoadCallback = function(){
